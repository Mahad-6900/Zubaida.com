...
class SimpleChatbot {
  constructor() {
    this.responses = {
      greeting: [
        "Hello! I'm Zubaida Malik's AI assistant. I'm here to help you learn about her work, skills, and services. How can I assist you today?",
        "Hi there! Welcome! I can help you with questions about Zubaida's expertise in content strategy, copywriting, and AI-powered marketing. What would you like to know?",
        "Welcome! I'm here to answer any questions about Zubaida's work and experience. Feel free to ask me anything!"
      ],
      skills: [
      ...
      contact: [
        "If you'd like to connect with Zubaida directly, you can reach her at zubimalik5656@gmail.com. She'd be happy to discuss how she can help with your specific needs.",
        "Zubaida would love to hear from you! Feel free to email her at zubimalik5656@gmail.com to discuss your project."
      ],
      services: [
  ...
  generateResponse(userMessage) {
    ...
    if (this.matchesKeywords(messageLower, ["hello", "hi", "hey", "greetings", "good morning", "good afternoon", "good evening"])) {
      return this.getRandomResponse("greeting");
    } else if (this.matchesKeywords(messageLower, ["skill", "expertise", "what can", "abilities", "specializ", "capabilities"])) {
      return this.getRandomResponse("skills");
    } else if (this.matchesKeywords(messageLower, ["experience", "project", "work done", "portfolio", "track record", "background"])) {
      return this.getRandomResponse("experience");
    } else if (this.matchesKeywords(messageLower, ["contact", "email", "reach", "connect", "get in touch", "hire"])) {
      return this.getRandomResponse("contact");
    } else if (this.matchesKeywords(messageLower, ["service", "help", "offer", "provide", "do for me", "what do you do"])) {
  ...
  async handleStreamingResponse(fullResponse) {
    ...
    try {
      ...
      for (let i = 0; i < words.length; i++) {
        ...
        assistantMessage += words[i] + (i < words.length - 1 ? " " : "");
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = { ChatInterface, SimpleChatbot };
}
