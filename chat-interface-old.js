...
class AIAssistant {
  constructor() {
    this.apiUrl = '/api/chat'; // Use local API endpoint
  }
  ...
  async *streamResponse(response) {
    // For now, just yield the full response word by word
    // In a real implementation, this would handle actual streaming
